		...
		<div class="container">
			...
			<div class="footer-cpy text-center">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p> Responsive Blog Site <?php $current=date("Y"); print_r($current);?> | Brought To You  
						<a href="https://www.instagram.com/retro_riders_mysuru?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==">ADP</a>
					</p>
